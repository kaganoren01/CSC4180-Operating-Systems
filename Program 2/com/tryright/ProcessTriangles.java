...
public class ProcessTriangles {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<TrianglesUtils.Point> points = TrianglesUtils.readPoints(filename);
            ...
            int actualProcesses = Math.min(numProcesses, points.size());
     ...
     */
    private static int countWithMultipleProcesses(List<TrianglesUtils.Point> points, int numProcesses)
            throws IOException {
